    ...
    <section className="receptionist-patients-section">
      ...
      <div className="receptionist-patients-card">
        ...
        {patients.map((patient) => (
          <div className="receptionist-patient-row" key={patient.id}>
            ...
            <span className="receptionist-patient-cell">{patient.age}</span>

            <span className="receptionist-patient-cell">{patient.phone}</span>
            ...
            <div className="receptionist-patient-actions">
              ...
              <button type="button" className="receptionist-patient-edit">
                Edit
              </button>
            </div>
          </div>
